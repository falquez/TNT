...
#ifndef _TNT_OPERATOR_PROJECTION_H
#define _TNT_OPERATOR_PROJECTION_H
...
namespace TNT::Operator {
  ...
  public:
    Projection(const UInt dimW, const UInt dimH, const UInt length);

    Projection(const std::string &config_file, const Configuration::MPO &mpo, const UInt length = 0,
...
#endif //_TNT_OPERATOR_PROJECTION_H
